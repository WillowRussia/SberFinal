  ...
  Padding buildPaddingHeaderCard(int index) {
    return Padding(
      ...
      child: ElevatedButton(
        style: ButtonStyle(
            backgroundColor: MaterialStateProperty.all(tabBarNotifier.index == index ? Colors.red : Colors.blue),
        shape: MaterialStateProperty.all(StadiumBorder())),
        onPressed: () => headerListChangePosition(index),
        child: Text("${shopList[index].categoryName} $index",style: TextStyle(color: Colors.white),),
      ),
    );
  }
}
